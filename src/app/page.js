...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* Navbar */}
      <nav className="bg-white fixed w-full z-50 top-0 start-0 border-b border-slate-200">
        <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <span className="self-center text-2xl font-semibold whitespace-nowrap text-slate-900">
              Soft<span className="text-orange-600">Network</span>
            </span>
          </a>
          ...
          <div
            ...
            id="navbar-solid"
          >
            <ul className="flex flex-col font-medium mt-4 rounded-lg bg-slate-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent">
              {navItems.map((item) => (
                <li key={item.name}>
                  <a
                    href={item.href}
                    ...
                    className={`block py-2 px-3 md:p-0 rounded md:bg-transparent 
                      ${
                        item.name === "Home"
                          ? "text-white bg-orange-600 md:text-orange-600 md:bg-transparent"
                          : "text-slate-900 hover:bg-slate-100 md:hover:bg-transparent md:border-0 md:hover:text-orange-600"
                      }
      ...
      >
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          {/* ลบ grayscale / hover ขาวดำ ออกแล้ว */}
        ...
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-slate-100">
            <div className="grid lg:grid-cols-2">
              ...
              {/* แผนที่ – ใช้ลิงก์ Google Maps ที่ให้มา และเอา grayscale animation ออกแล้ว */}
